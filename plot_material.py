...
def reg_corr_plot():
    class LinearRegression:
        def __init__(self, beta1, beta2, error_scale, data_size):
            ...
            self.y = self.beta1 + self.beta2*self.x + \
    ...
    ax[0, 0].annotate(r'$\rho={:.4}$'.format(
        lrg1.x_y_cor()), xy=(0.1, 0.9), xycoords='axes fraction')
    ...
    ax[0, 1].annotate(r'$\rho={:.4}$'.format(
        lrg2.x_y_cor()), xy=(0.1, 0.9), xycoords='axes fraction')
    ...
    ax[0, 2].annotate(r'$\rho={:.4}$'.format(
        lrg3.x_y_cor()), xy=(0.1, 0.9), xycoords='axes fraction')
    ...
    ax[0, 3].annotate(r'$\rho={:.4}$'.format(
        lrg4.x_y_cor()), xy=(0.1, 0.9), xycoords='axes fraction')
    ...
    ax[1, 0].annotate(r'$\rho={:.4}$'.format(
        lrg5.x_y_cor()), xy=(0.1, 0.9), xycoords='axes fraction')
    ...
    ax[1, 1].annotate(r'$\rho={:.4}$'.format(
        lrg6.x_y_cor()), xy=(0.1, 0.9), xycoords='axes fraction')
    ...
    ax[1, 2].annotate(r'$\rho={:.4}$'.format(
        lrg7.x_y_cor()), xy=(0.1, 0.9), xycoords='axes fraction')
    ...
    ax[1, 3].annotate(r'$\rho={:.4}$'.format(
        lrg8.x_y_cor()), xy=(0.1, 0.9), xycoords='axes fraction')
...
def central_limit_theorem_plot():
    ...
    ax[0, 0].plot([x[0], x[0]], [0, 1/(b-a)], lw=3,
                  color='r', alpha=.9)  # vertical line
